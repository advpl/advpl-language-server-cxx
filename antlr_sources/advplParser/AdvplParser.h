...
class  AdvplParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleSources = 0, RuleLinePreProcessor = 1, RuleCrlf = 2, RuleCrlfEmpty = 3
  };

  AdvplParser(antlr4::TokenStream *input);
  ~AdvplParser();
  ...
  class LinePreProcessorContext;
  class CrlfContext;
  class CrlfEmptyContext; 
  ...
  public:
    ...
    LinePreProcessorContext *linePreProcessor();
  ...
  class  LinePreProcessorContext : public antlr4::ParserRuleContext {
  public:
    LinePreProcessorContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  CrlfEmptyContext : public antlr4::ParserRuleContext {
  public:
    CrlfEmptyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<antlr4::tree::TerminalNode *> CRLF();
    antlr4::tree::TerminalNode* CRLF(size_t i);
